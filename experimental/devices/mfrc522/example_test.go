...
import (
	...
	"github.com/meandrewdev/periph/experimental/devices/mfrc522"
	"github.com/meandrewdev/periph/experimental/devices/mfrc522/commands"
	"github.com/meandrewdev/periph/host"
	"github.com/meandrewdev/periph/host/rpi"
)
...
func Example() {
	...
	// Using SPI as an example. See package "github.com/meandrewdev/periph/conn/spi/spireg" for more details.
	p, err := spireg.Open("")
	if err != nil {
		log.Fatal(err)
	}
